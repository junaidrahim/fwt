...
| P2 | `fwt cd --help` could try to change into help text; Cargo users needed a source-tree shim path. | `shell-init` embeds the shim. Help/errors leave the working directory unchanged. Bash/Zsh test covers paths containing spaces. |
